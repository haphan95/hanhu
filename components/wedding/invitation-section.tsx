    ...
    >
      ...
      >
        ...
        <h2 className="font-serif text-xl md:text-2xl font-semibold text-foreground mb-2 italic">
          <span className="font-serif text-primary">{displayName}</span> ơi, {self} cưới rồi nè 💍
        </h2>
        ...
        <p className="text-foreground/90 leading-relaxed text-sm md:text-base mb-4">
          Sau một hành trình &ldquo;tình trong như đã&rdquo;, {self} quyết định về chung một nhà 🎉
        </p>
        <p className="text-foreground/90 leading-relaxed text-sm md:text-base mb-4">
          Và sẽ thật thiếu nếu ngày vui này không có {guest} ở đó.
        </p>
        <p className="text-foreground/90 leading-relaxed text-sm md:text-base mb-4">
          Lên đồ xinh xắn, dành chút thời gian đến chung vui, ăn uống, chụp hình và quẩy nhẹ cùng {self} nha ✨
        </p>
        <p className="text-foreground font-semibold leading-relaxed text-sm md:text-base italic">
          Sự hiện diện của {guest} là {self} vui x10 rồi đó!
        </p>
